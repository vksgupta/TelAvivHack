...
//fbicebreak, 1c3br34k3r!!1214

//CREATE DATABASE crowdjuke;
//grant all on crowdjuke.* to 'crowdjuke' identified by 'j&jsSD#@(82mz!';
...
Class DB {
  ...
  function __construct() {
    self::$conn = mysql_connect('<SERVER_NAME>', '<USER_NAME>', '<PASSWORD>');

    if (!self::$conn) {
      die('Could not connect: ' . mysql_error());
    }

    mysql_select_db("apansari_grasshopper", self::$conn);
  }
